...
MINSDK=19
APP=src/com/example/musicalstructureapp
...
music.apk: music.aligned.apk keystore.jks
...
music.aligned.apk: music.unsigned.apk
	zipalign -f -p 4 $< $@

music.unsigned.apk: dex/classes.dex AndroidManifest.xml
...
$(APP)/MainActivity.class $(APP)/Music.class: $(APP)/*.java $(APP)/R.java
	javac $(APP)/Music.java
